<template>
  <q-page>
    <div class="hero-section q-pa-xl text-white row items-center no-wrap"
      ...
      <div class="col-12 col-md-6 q-pr-lg">
        ...
        <p class="text-h6 q-mb-lg" style="max-width: 500px;">
          Ao infinito e além! Explore os brinquedos da Pixar, roupas, itens colecionáveis e mais. Descubra a magia dos
          filmes da Pixar com nossa coleção exclusiva de produtos inspirados em Toy Story e muito mais.
        </p>
        <q-btn label="Explorar mais" color="yellow-8" text-color="black" size="lg" no-caps @click="goToCatalog" />
      </div>
    </div>
...
onMounted(async () => {
  ...
  toys.value = allToys;
  console.log("Brinquedos carregados:", toys.value);
});
</script>
